...
#https://books.toscrape.com/catalogue/category/books/historical-fiction_4/page-1.html
...
def get_books_in_category(category_url):
    ...
    while True:
        ...
        print("Processing page:", page_url)  # Отладочное сообщение
        ...
        if not new_books:
            print("No books found on this page")  # Отладочное сообщение
            break
...
def main():
    ...
    for category in categories[1:]:  # skip the first one as it's not a category
        ...
        print("Processing category:", category_name)  # Отладочное сообщение
